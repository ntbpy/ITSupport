...
namespace MIT.Framework.Caching.Telemetry;
...
public static class CachingTelemetry
{
    ...
    public const string ActivitySourceName = "MIT.Caching";

    /// <summary>Name of the <see cref="Meter"/> used for cache metrics.</summary>
    public const string MeterName = "MIT.Caching";
