using MIT.Framework.Caching.Telemetry;
using Mediator;
...
using static MIT.Framework.Web.Observability.OpenTelemetry.OpenTelemetryOptions;

namespace MIT.Framework.Web.Observability.OpenTelemetry;
...
public static class Extensions
{
    ...
    public static IHostApplicationBuilder AddHeroOpenTelemetry(this IHostApplicationBuilder builder)
    {
        ...
        // name ("MIT.Starter.Api") de-correlates our telemetry from that resource, so the dashboard lists the
        ...
        bool useEnvEndpoint)
    {
        ...
        builder.Services.AddOpenTelemetry()
            ...
            .WithMetrics(metrics =>
            {
                ...
                metrics.AddMeter("MIT.Modules.Auditing");
