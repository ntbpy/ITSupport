...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MIT.Framework.Shared.Multitenancy.AppTenantInfo", b =>
                {
            ...
            modelBuilder.Entity("MIT.Modules.Multitenancy.Domain.TenantExpiryNotice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MIT.Modules.Multitenancy.Domain.TenantTheme", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MIT.Modules.Multitenancy.Provisioning.TenantProvisioning", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MIT.Modules.Multitenancy.Provisioning.TenantProvisioningStep", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MIT.Modules.Multitenancy.Provisioning.TenantProvisioningStep", b =>
                {
                    b.HasOne("MIT.Modules.Multitenancy.Provisioning.TenantProvisioning", "Provisioning")
                        .WithMany("Steps")
