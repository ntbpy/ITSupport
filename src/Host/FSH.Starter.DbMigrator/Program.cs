...
if (string.IsNullOrWhiteSpace(builder.Configuration["JwtOptions:SigningKey"]))
{
    builder.Configuration.AddInMemoryCollection(new Dictionary<string, string?>
    {
        ...
        ["JwtOptions:Issuer"] = builder.Configuration["JwtOptions:Issuer"] ?? "MIT.local",
        ["JwtOptions:Audience"] = builder.Configuration["JwtOptions:Audience"] ?? "MIT.clients",
    });
}
...
builder.Services.AddSingleton<MIT.Framework.Jobs.Services.IJobService, NoOpJobService>();
