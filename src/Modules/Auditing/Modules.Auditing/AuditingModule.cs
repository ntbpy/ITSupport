...
using MIT.Modules.Auditing.Features.v1.GetAuditById;
...
using MIT.Modules.Auditing.Persistence;
using Hangfire;
...
public class AuditingModule : IModule
{
    public void ConfigureServices(IHostApplicationBuilder builder)
    {
        ...
        MIT.Framework.Shared.Constants.PermissionConstants.Register(
            MIT.Modules.Auditing.Contracts.Authorization.AuditingPermissions.All);
