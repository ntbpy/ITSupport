...
using MIT.Modules.Multitenancy.Features.v1.AdjustTenantValidity;
using MIT.Modules.Multitenancy.Features.v1.ChangeTenantActivation;
using MIT.Modules.Multitenancy.Features.v1.CreateTenant;
using MIT.Modules.Multitenancy.Features.v1.GetMyTenantStatus;
using MIT.Modules.Multitenancy.Features.v1.GetTenantMigrations;
using MIT.Modules.Multitenancy.Features.v1.GetTenants;
using MIT.Modules.Multitenancy.Features.v1.GetTenantStatus;
using MIT.Modules.Multitenancy.Features.v1.GetTenantTheme;
using MIT.Modules.Multitenancy.Features.v1.ResetTenantTheme;
using MIT.Modules.Multitenancy.Features.v1.TenantProvisioning.GetTenantProvisioningStatus;
using MIT.Modules.Multitenancy.Features.v1.TenantProvisioning.RetryTenantProvisioning;
using MIT.Modules.Multitenancy.Features.v1.RenewTenant;
using MIT.Modules.Multitenancy.Features.v1.UpdateTenantTheme;
using MIT.Modules.Multitenancy.Provisioning;
using MIT.Modules.Multitenancy.Services;
using Hangfire;
...
public sealed class MultitenancyModule : IModule
{
    public void ConfigureServices(IHostApplicationBuilder builder)
    {
        ...
        MIT.Framework.Shared.Constants.PermissionConstants.Register(
            MIT.Modules.Multitenancy.Contracts.Authorization.MultitenancyPermissions.All);
        ...
        builder.Services.AddSingleton<
            MIT.Framework.Shared.Multitenancy.ITenantInitialPasswordBuffer,
