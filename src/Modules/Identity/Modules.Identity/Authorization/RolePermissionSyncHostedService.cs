...
namespace MIT.Modules.Identity.Authorization;

/// <summary>
/// Runs once on host startup: iterates every tenant and adds any permission claims that
/// have been registered via <see cref="MIT.Framework.Shared.Constants.PermissionConstants"/>
...
/// In production, the tenant catalog is migrated by the standalone <c>MIT.Starter.DbMigrator</c>
