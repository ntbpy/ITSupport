...
public class HandlerValidatorPairingTests
{
    ...
    private static readonly string[] KnownMissingCommandHandlers = [
        "MIT.Modules.Billing.Features.v1.Invoices.VoidInvoice.VoidInvoiceCommandHandler",
        "MIT.Modules.Billing.Features.v1.Invoices.MarkInvoicePaid.MarkInvoicePaidCommandHandler",
        "MIT.Modules.Billing.Features.v1.Invoices.IssueInvoice.IssueInvoiceCommandHandler",
        "MIT.Modules.Catalog.Features.v1.Products.RestoreProduct.RestoreProductCommandHandler",
        "MIT.Modules.Catalog.Features.v1.Products.DeleteProduct.DeleteProductCommandHandler",
        "MIT.Modules.Catalog.Features.v1.Categories.RestoreCategory.RestoreCategoryCommandHandler",
        "MIT.Modules.Catalog.Features.v1.Categories.DeleteCategory.DeleteCategoryCommandHandler",
        "MIT.Modules.Catalog.Features.v1.Brands.RestoreBrand.RestoreBrandCommandHandler",
        "MIT.Modules.Catalog.Features.v1.Brands.DeleteBrand.DeleteBrandCommandHandler",
        "MIT.Modules.Identity.Features.v1.TwoFactor.Enroll.EnrollTwoFactorCommandHandler",
        "MIT.Modules.Identity.Features.v1.Impersonation.EndImpersonation.EndImpersonationCommandHandler",
        "MIT.Modules.Multitenancy.Features.v1.TenantProvisioning.RetryTenantProvisioning.RetryTenantProvisioningCommandHandler",
        "MIT.Modules.Multitenancy.Features.v1.ResetTenantTheme.ResetTenantThemeCommandHandler",
        "MIT.Modules.Tickets.Features.v1.Tickets.RestoreTicket.RestoreTicketCommandHandler",
        "MIT.Modules.Tickets.Features.v1.Tickets.ResolveTicket.ResolveTicketCommandHandler",
        "MIT.Modules.Tickets.Features.v1.Tickets.ReopenTicket.ReopenTicketCommandHandler",
        "MIT.Modules.Tickets.Features.v1.Tickets.AssignTicket.AssignTicketCommandHandler"
    ];

    private static readonly string[] KnownMissingQueryHandlers = [
        "MIT.Modules.Billing.Features.v1.Invoices.GetMyInvoices.GetMyInvoicesQueryHandler",
        "MIT.Modules.Billing.Features.v1.Invoices.GetInvoices.GetInvoicesQueryHandler",
        "MIT.Modules.Catalog.Features.v1.Products.SearchProducts.SearchProductsQueryHandler",
        "MIT.Modules.Catalog.Features.v1.Products.ListTrashedProducts.ListTrashedProductsQueryHandler",
        "MIT.Modules.Catalog.Features.v1.Categories.SearchCategories.SearchCategoriesQueryHandler",
        "MIT.Modules.Catalog.Features.v1.Categories.ListTrashedCategories.ListTrashedCategoriesQueryHandler",
        "MIT.Modules.Catalog.Features.v1.Brands.SearchBrands.SearchBrandsQueryHandler",
        "MIT.Modules.Catalog.Features.v1.Brands.ListTrashedBrands.ListTrashedBrandsQueryHandler",
        "MIT.Modules.Identity.Features.v1.Sessions.GetTenantSessions.GetTenantSessionsQueryHandler",
        "MIT.Modules.Tickets.Features.v1.Tickets.SearchTickets.SearchTicketsQueryHandler",
        "MIT.Modules.Tickets.Features.v1.Tickets.ListTrashedTickets.ListTrashedTicketsQueryHandler"
    ];
