...
using MIT.Modules.Identity.Contracts.v1.Users.UpdateUser;
...
public sealed class UpdateUserCommandHandlerTests
{
    ...
    public async Task Handle_Should_ThrowException_When_UserServiceThrows()
    {
        ...
        _userService.UpdateAsync(Arg.Any<string>(), Arg.Any<string>(), Arg.Any<string>(), Arg.Any<string>(), Arg.Any<MIT.Framework.Shared.Storage.FileUploadRequest>(), Arg.Any<bool>())
