...
using MIT.Modules.Auditing.Contracts.v1.GetAuditsByCorrelation;
using MIT.Modules.Auditing.Contracts.v1.GetAuditsByTrace;
using MIT.Modules.Auditing.Contracts.v1.GetAuditSummary;
using MIT.Modules.Auditing.Contracts.v1.GetExceptionAudits;
using MIT.Modules.Auditing.Contracts.v1.GetSecurityAudits;
using MIT.Modules.Auditing.Features.v1.GetAudits;
using MIT.Modules.Auditing.Features.v1.GetAuditsByCorrelation;
using MIT.Modules.Auditing.Features.v1.GetAuditsByTrace;
using MIT.Modules.Auditing.Features.v1.GetAuditSummary;
using MIT.Modules.Auditing.Features.v1.GetExceptionAudits;
using MIT.Modules.Auditing.Features.v1.GetSecurityAudits;
