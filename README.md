...
| `src/Host/MIT.Starter.AppHost` | .NET Aspire orchestrator (Postgres, Valkey, MinIO, migrator, API, both React apps) |
...
```bash
dotnet test src/MIT.Starter.slnx        # backend: unit + architecture + Testcontainers integration
