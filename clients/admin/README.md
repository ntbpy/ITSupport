...
- Node.js 20+
- The API running locally (`dotnet run --project src/Host/MIT.Starter.Api`, defaults to `http://localhost:5030`)
...
2. Access + refresh tokens are stored in `localStorage` (keys prefixed `MIT.admin.`).
