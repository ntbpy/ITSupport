...
// Mirrors MIT.Modules.Files.Domain.Visibility — the server serializes this
...
// Mirrors MIT.Modules.Files.Domain.FileAssetStatus — serialized as string name.
...
// Mirrors MIT.Modules.Files.Contracts.v1.DTOs.FileAssetDto.
