...
export const FONT_STORAGE_KEY = "MIT.font";
export const ACCENT_STORAGE_KEY = "MIT.accent";
/** Stores `{ h, c }` for the custom accent — h = hue (0-360),
 *  c = chroma scale (0.6 → 1.2 of the indigo template). */
export const CUSTOM_ACCENT_STORAGE_KEY = "MIT.accent.custom";

export type DensityMode = "comfortable" | "compact";
export const DENSITY_STORAGE_KEY = "MIT.density";
