const ACCESS_KEY = "MIT.dashboard.accessToken";
const REFRESH_KEY = "MIT.dashboard.refreshToken";
const TENANT_KEY = "MIT.dashboard.tenant";
const PERMS_KEY = "MIT.dashboard.permissions";
...
const STASH_ACCESS_KEY = "MIT.dashboard.impersonation.actorAccessToken";
const STASH_REFRESH_KEY = "MIT.dashboard.impersonation.actorRefreshToken";
const STASH_TENANT_KEY = "MIT.dashboard.impersonation.actorTenant";
